...
Controller::Controller(View &view, Socket& skt,Socket& sktAux) : sktAux(std::move(sktAux)),view(view),protocol(skt), scene(get_cantidad_jugadores(*gXML_doc[0], *gXML_doc[1], *gXML_parse_result)){
